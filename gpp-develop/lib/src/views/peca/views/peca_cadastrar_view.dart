...
class PecaCadastrarView extends StatefulWidget {
  int? idProduto;
  PecaCadastrarView({this.idProduto, Key? key}) : super(key: key);

  @override
  _PecaCadastrarViewState createState() => _PecaCadastrarViewState();
}

class _PecaCadastrarViewState extends State<PecaCadastrarView> {
