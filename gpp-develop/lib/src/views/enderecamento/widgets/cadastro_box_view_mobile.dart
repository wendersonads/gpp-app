...
class CadastroBoxViewMobile extends StatefulWidget {
  String? idPrateleira;
  CadastroBoxViewMobile({this.idPrateleira});

  @override
  _CadastroBoxViewState createState() => _CadastroBoxViewState();
}

class _CadastroBoxViewState extends State<CadastroBoxViewMobile> {
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            const Expanded(child: const TextComponent('Und. Medida', fontWeight: FontWeight.bold))
                                          ],
                                        ),
                                        const Divider(
                                          thickness: 1,
