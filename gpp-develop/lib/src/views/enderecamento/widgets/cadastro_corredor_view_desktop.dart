...
class CadastroCorredorViewDesktop extends StatefulWidget {
  String? idPiso;
  CadastroCorredorViewDesktop({this.idPiso});
...
class _CadastroCorredorViewState extends State<CadastroCorredorViewDesktop> {
    ...
    try {
      if (await Notificacao.confirmacao("você deseja excluir o corredor?")) {
        if (await enderecamentoController.repository
            .excluirCorredor(widget.idPiso.toString(), excluiCorredor)) {
      ...
      builder: (BuildContext context) {
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: const Text("Cadastro do Corredor"),
              actions: <Widget>[
                Form(
                  key: formKey,
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        InputComponent(
                          label: 'Piso',
                          initialValue: corredorEnderecamentoReplacement.id_piso
                              .toString(),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Flexible(
                              child: const TitleComponent('Corredores')),
                          ButtonComponent(
                              onPressed: () {
                    ...
                    enderecamentoController.isLoaded
                        ? Container(
                            ...
                            child: ListView.builder(
                              itemCount:
                                  enderecamentoController.listaCorredor.length,
