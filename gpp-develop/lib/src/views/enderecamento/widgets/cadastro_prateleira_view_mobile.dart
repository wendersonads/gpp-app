...
class CadastroPrateleiraViewMobile extends StatefulWidget {
  String? idEstante;
  CadastroPrateleiraViewMobile({this.idEstante});
...
class _CadastroPrateleiraViewState extends State<CadastroPrateleiraViewMobile> {
  ...
  buscarTodos(String idEstante) async {
    try {
      enderecamentoController.listaPrateleira = await enderecamentoController.repository.buscarPrateleira(int.parse(idEstante));
      if (mounted) {
        setState(() {
                              ...
                              children: [
                                ButtonComponent(
                                    onPressed: () async {
                                      ...
                                      await handleCreate(
                                          context, enderecamentoController.prateleiraModel, widget.idEstante.toString());
                                    },
                                    text: 'Adicionar')
                              ],
                            ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Flexible(child: const TitleComponent('Prateleiras')),
                          ButtonComponent(
                              onPressed: () {
                                ...
                                return Container(
                                  ...
                                  child: CardWidget(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          const Expanded(child: const TextComponent('Prateleira', fontWeight: FontWeight.bold)),
                                        ...
                                        children: [
                                          Expanded(
                                            child: SelectableText(
                                                enderecamentoController.listaPrateleira[index].desc_prateleira.toString()),
                                          ),
                                          Expanded(
                                            child: Row(
                                              children: [
