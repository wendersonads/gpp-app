...
class EntradaHistoricoViewDesktop extends StatefulWidget {
  const EntradaHistoricoViewDesktop({Key? key}) : super(key: key);

  @override
  _EntradaHistoricoViewState createState() => _EntradaHistoricoViewState();
}

class _EntradaHistoricoViewState extends State<EntradaHistoricoViewDesktop> {
