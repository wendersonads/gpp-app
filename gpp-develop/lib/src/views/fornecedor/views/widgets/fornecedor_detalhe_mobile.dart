...
class FornecedorDetalheMobile extends StatelessWidget {
  const FornecedorDetalheMobile({
    Key? key,
  }) : super(key: key);
                          ...
                          Obx(
                            () => GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: TextComponent('E-mail do fornecedor'),
                              ),
                            ),
                          )
                        ],
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      flex: 12,
                                      child: InputComponent(
                                        initialValue: controller.fornecedor
                                                .fornecedorEmail?.eMail
                                                ?.toString() ??
                                            null,
                                        onSaved: (value) {
                                          controller
                                                  .fornecedor.fornecedorEmail =
