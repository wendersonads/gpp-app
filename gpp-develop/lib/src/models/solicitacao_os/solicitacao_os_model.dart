...
class SolicitacaoOSModel {
  ...
  SolicitacaoOSModel.fromJson(Map<String, dynamic> json) {
    ...
    this.caminhoVideo = json['caminho_video'];
    ...
    this.imagens = json['imagem_solicitacao_ordem_servico'] != null
        ...
        : null;
    this.videos = json['video_solicitacao_ordem_servico'] != null
        ? json['video_solicitacao_ordem_servico'].map<VideoOsModel>((video) {
            return VideoOsModel.fromJson(video);
          }).toList()
        : null;
    ...
    this.observacaoAprovacao = json['observacao_aprovacao'];
    this.classificacaoProduto = json['classificacao_produto'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['caminho_video'] = this.caminhoVideo;
    ...
    data['imagem_solicitacao_ordem_servico'] = this.imagens != null
        ...
        : [];
    data['video_solicitacao_ordem_servico'] = this.videos != null
    ...
    data['observacao_aprovacao'] = this.observacaoAprovacao;
    data['classificacao_produto'] = this.classificacaoProduto;
