...
class ApiService {
  ...
  Future<dynamic> put(String endpoint, body) async {
    try {
      var uri = Uri.parse(baseUrl! + endpoint);
      var response = await http
          .put(uri, headers: getHeader(), body: jsonEncode(body))
          .timeout(const Duration(seconds: 300));
      ;
  ...
  Future<dynamic> patch(String endpoint, body) async {
    try {
      var uri = Uri.parse(baseUrl! + endpoint);
      var response = await http
          .patch(uri, headers: getHeader(), body: jsonEncode(body))
          .timeout(const Duration(seconds: 300));
      ;
